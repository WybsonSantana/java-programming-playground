...
public class AircraftWeightControl {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (totalPassengersWeight + passengerWeight > maxSupportedAircraftWeight) {
                System.out.println("Oops! Unable to add passenger. Maximum aircraft load weight exceeded.");
                continue;
            }
        ...
        System.out.printf("Aircraft status: %s%n", totalPassengersWeight > maxSupportedAircraftWeight ? "Excess weight" : "Aircraft released!");
